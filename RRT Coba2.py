...
class RRT:
    ...
    def planning(self, animation=True):
        ...
        for i in range(self.max_iter):
            ...
            if (
                self.check_if_outside_play_area(new_node, self.play_area)
...
def main():
    ...
    # Start & Goal (sesuai tanda X merah di gambar)
    start = [0, 0]
    goal = [6, 10]

    # Obstacle (posisi & radius disesuaikan dengan gambar)
    obstacleList = [
        (1, 10, 1),
        (3, 10, 1),
        (3, 8, 1),
    ...
    rrt = RRT(
        ...
        expand_dis=1.0,          # lebih kecil biar halus
        path_resolution=0.2,     # lebih smooth
        goal_sample_rate=10,
        max_iter=500
    )
    ...
    if path is None:
        ...
        # plot start & goal sebagai X merah
